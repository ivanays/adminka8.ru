      ...
      <?php 	if ($user['uid'] == $user['group_id']) {?>
        <li>
          <form action="" method="post">
              <input type="hidden" name="ouid" value="<?php htmlout($oid); ?>">				   
            <div>
   ...
   <ul>
	  ...
	  <div>
	    <label for="cash_in">ПОЛУЧИТЬ: </label>
	     <input type="number"  name = "cash_in" id = "cash_in" min="0.00" max="100000" step="50.00"  value = "0.00" />      
	  </div>
	<div>
	  <div>
	    <label for="cash_out">ВЫДАТЬ: </label>
	     <input type="number"  name = "cash_out" id = "cash_out" min="0.00" max="100000" step="50.00"  value = "0.00" />      
	  </div>
	  <div>
	...
	<div>
	  ...
	  <div>
	    <label for="order_plus_add">РАСЧЁТ ДОПЛАТЫ: </label>
	     <input type="number"  name = "order_plus_add" id = "order_plus_add" min="0.00" max="100000" step="50.00"  value = "0.00" />      
	  </div>
	<div>
	  ...
	  <div>
	    <label for="order_sale_add">РАСЧЁТ СКИДКИ: </label>
	     <input type="number"  name = "order_sale_add" id = "order_sale_add" min="0.00" max="100000" step="50.00"  value = "0.00" />      
	  </div>
	<div>
